  ...
  ceremonies: [
    {
      ...
      steps: [
        ...
        { text: "Nhà trai đến ĐÚNG GIỜ đã hẹn — không sớm quá, không trễ" },
        { text: "Chào hỏi, giới thiệu thành phần hai bên gia đình" },
        { text: "Nhà trai trao lễ vật tượng trưng cho nhà gái" },
        { text: "Nhà gái nhận lễ, mời ngồi, rót trà" },
        { text: "Bàn bạc: ngày hỏi, ngày cưới, số mâm quả, lễ vật, tiền nạp tài" },
        { text: "Thống nhất phong tục: theo miền nào, tục lệ gì cần giữ" },
        { text: "Thắp hương gia tiên nhà gái (nếu bàn thờ sẵn)" },
        { text: "Cơm thân mật, nâng ly chúc mừng" },
        { text: "Tổng kết, xác nhận lại các thỏa thuận trước khi ra về" },
      ],
      gifts: [
