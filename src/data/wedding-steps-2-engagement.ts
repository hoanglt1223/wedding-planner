  ...
  ceremonies: [
    {
      ...
      steps: [
        ...
        { text: "Nhà trai đến ĐÚNG GIỜ đã hẹn — không sớm quá, không trễ", responsible: "Đại diện nhà trai" },
        { text: "Chào hỏi, giới thiệu thành phần hai bên gia đình", responsible: "Hai họ" },
        { text: "Nhà trai trao lễ vật tượng trưng cho nhà gái", responsible: "Đại diện nhà trai" },
        { text: "Nhà gái nhận lễ, mời ngồi, rót trà", responsible: "Gia đình nhà gái" },
        { text: "Bàn bạc: ngày hỏi, ngày cưới, số mâm quả, lễ vật, tiền nạp tài", responsible: "Hai họ" },
        { text: "Thống nhất phong tục: theo miền nào, tục lệ gì cần giữ", responsible: "Hai họ" },
        { text: "Thắp hương gia tiên nhà gái (nếu bàn thờ sẵn)", responsible: "Gia đình nhà gái" },
        { text: "Cơm thân mật, nâng ly chúc mừng", responsible: "Gia đình nhà gái" },
        { text: "Tổng kết, xác nhận lại các thỏa thuận trước khi ra về", responsible: "Hai họ" },
      ],
      gifts: [
