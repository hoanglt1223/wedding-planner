...
export const THEMES: AppTheme[] = [
  {
    ...
    primaryLight: "#fef2f2",
    accent: "#c0392b",
    primaryHSL: "hsl(0 72% 36%)",
    primaryForegroundHSL: "hsl(0 0% 100%)",
    surface: "#FFFBF5",
    surfaceMuted: "#FFF5EB",
    themeBorder: "#E8DDD0",
    bg: "#FDF8F3",
