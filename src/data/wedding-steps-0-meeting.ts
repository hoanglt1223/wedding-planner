...
export const STEP_MEETING: WeddingStep = {
  ...
  notes: [
    ...
    "Bàn bạc nội bộ: bước CỰC KỲ quan trọng — ghi chép tất cả thỏa thuận",
  ],
  ...
  ceremonies: [
    {
      ...
      steps: [
        ...
        { text: "Giới thiệu hai bên", time: "10:00", responsible: "Cô dâu & Chú rể" },
        { text: "Trò chuyện thân mật", time: "10:15", responsible: "Bố mẹ 2 bên" },
        { text: "Trao đổi sơ bộ ý định", time: "10:45", responsible: "Bố mẹ 2 bên" },
        { text: "Kết thúc vui vẻ — KHÔNG chốt gì", time: "11:15", responsible: "Cô dâu & Chú rể" },
      ],
      people: [
