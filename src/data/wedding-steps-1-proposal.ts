...
export const STEP_PROPOSAL: WeddingStep = {
  ...
  ceremonies: [
    ...
    },
    {
      ...
      checklist: [
        { text: "Chọn studio / photographer (xem portfolio)", cost: 15000000, categoryKey: "photo" },
        { text: "Chọn gói chụp: cơ bản (50-100 ảnh) hay cao cấp (+ flycam, video)", cost: 0, categoryKey: "photo" },
        { text: "Đặt cọc 50% studio", cost: 0, categoryKey: "photo" },
        { text: "Chọn & thử váy cưới pre-wedding (studio thường cho mượn 2-3 bộ)", cost: 0, categoryKey: "clothes" },
        { text: "Book vé máy bay + khách sạn (nếu chụp xa — book sớm!)", cost: 10000000, categoryKey: "transport" },
        { text: "Lên danh sách location chụp (biển, nhà thờ, resort, đường ray…)", cost: 0, categoryKey: "other" },
        { text: "Chuẩn bị phụ kiện: voan, giày cưới, hoa cầm tay, kính", cost: 1000000, categoryKey: "other" },
        { text: "Kem chống nắng, nước uống, quạt mini (chụp ngoài trời)", cost: 100000, categoryKey: "other" },
        { text: "Backup plan nếu trời mưa (location trong nhà / cafe)", cost: 0, categoryKey: "other" },
        { text: "Nhận ảnh chỉnh sửa (thường 2-4 tuần sau)", cost: 0, categoryKey: "photo" },
      ],
      people: [
      ...
      ritualSteps: [
        "4:30-5:00 sáng: Thức dậy, makeup + làm tóc",
        "6:00-10:00: Chụp ngoại cảnh buổi sáng (golden hour bình minh)",
        "10:00-14:00: Nghỉ trưa, thay đồ, ăn uống",
        "14:00-15:00: Chụp trong nhà / studio / quán cafe",
        "16:00-18:30: Chụp ngoại cảnh chiều (golden hour hoàng hôn)",
        "(Optional) Chụp đêm với đèn fairy light / nến",
      ],
      tips: [
