  ...
  ceremonies: [
    {
      ...
      steps: [
        ...
        { text: "Chuẩn bị lễ vật: cặp vịt trống + rượu + trái cây", responsible: "Chú rể" },
        { text: "Cô dâu chú rể (+ ba mẹ chồng nếu có) đến nhà gái", responsible: "Cô dâu & chú rể" },
        { text: "Chào hỏi ba mẹ, họ hàng nhà gái", responsible: "Cô dâu & chú rể" },
        { text: "Trao lễ vật — thể hiện lòng biết ơn", responsible: "Chú rể" },
        { text: "Ăn cơm cùng gia đình nhà gái", responsible: "Cả nhà" },
        { text: "Trò chuyện thân mật, chụp ảnh gia đình", responsible: "Cô dâu & chú rể" },
      ],
      people: [
