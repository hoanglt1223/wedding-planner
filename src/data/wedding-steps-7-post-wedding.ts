  ...
  ceremonies: [
    {
      ...
      steps: [
        ...
        { text: "Chuẩn bị lễ vật: cặp vịt trống + rượu + trái cây" },
        { text: "Cô dâu chú rể (+ ba mẹ chồng nếu có) đến nhà gái" },
        { text: "Chào hỏi ba mẹ, họ hàng nhà gái" },
        { text: "Trao lễ vật — thể hiện lòng biết ơn" },
        { text: "Ăn cơm cùng gia đình nhà gái" },
        { text: "Trò chuyện thân mật, chụp ảnh gia đình" },
      ],
      people: [
    ...
    },
    {
      ...
      steps: [
        ...
        // Ritual steps (non-checkable) — AFTER checklist
        { text: "Tuần 1: Gửi cảm ơn khách mời + tổng kết tiền mừng" },
        { text: "Tuần 1-2: Trả đồ thuê (váy, vest, phụ kiện)" },
        { text: "Tuần 2-4: Đăng ký kết hôn tại UBND" },
        { text: "Tháng 1-3: Nhận album ảnh + video, duyệt chỉnh sửa" },
        { text: "Liên tục: Viết cảm ơn vendor + review dịch vụ" },
      ],
      people: [
    ...
    },
    {
      ...
      steps: [
        ...
        // Ritual steps (non-checkable) — AFTER checklist
        { text: "Lên kế hoạch + book sớm (2-3 tháng trước cưới)" },
        { text: "Chuẩn bị giấy tờ, hành lý" },
        { text: "Khởi hành sau cưới 1-2 tuần (nghỉ ngơi sau đám cưới)" },
        { text: "Tận hưởng thời gian riêng tư, lãng mạn" },
        { text: "Chụp nhiều ảnh — kỷ niệm chuyến đi đầu tiên của vợ chồng" },
      ],
      people: [
