...
export const GROOM_CEREMONIES_A: Ceremony[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { text: "MC mời cô dâu chú rể lên sân khấu" },
      { text: "Nhạc nền lãng mạn nổi lên — spotlight tập trung" },
      { text: "Phù rể mang gối/hộp nhẫn lên sân khấu" },
      { text: "Chú rể đeo nhẫn cho cô dâu (tay trái, ngón áp út)" },
      { text: "Cô dâu đeo nhẫn cho chú rể" },
      { text: "Nụ hôn đầu tiên với tư cách vợ chồng 💋" },
      { text: "Khách mời vỗ tay, tung confetti/cánh hoa chúc mừng" },
    ],
    people: [
  ...
  },
  {
    ...
    steps: [
      ...
      // Ritual steps (non-checkable) — AFTER checklist
      { text: "MC mời cô dâu chú rể đến bàn bánh cưới" },
      { text: "Hai người cùng cầm dao, cắt miếng bánh đầu tiên" },
      { text: "Cho nhau ăn miếng bánh đầu tiên — ngọt ngào 🥰" },
      { text: "Rót champagne (hoặc đổ tháp ly từ trên xuống)" },
      { text: "Nâng ly — cả sảnh cùng nâng ly chúc mừng" },
      { text: "Uống giao bôi — hai người uống chung 1 ly" },
    ],
    people: [
