...
export const GROOM_CEREMONIES_A: Ceremony[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { text: "MC mời cô dâu chú rể lên sân khấu", responsible: "MC" },
      { text: "Nhạc nền lãng mạn nổi lên — spotlight tập trung", responsible: "Kỹ thuật âm thanh" },
      { text: "Phù rể mang gối/hộp nhẫn lên sân khấu", responsible: "Phù rể" },
      { text: "Chú rể đeo nhẫn cho cô dâu (tay trái, ngón áp út)", responsible: "Chú rể" },
      { text: "Cô dâu đeo nhẫn cho chú rể", responsible: "Cô dâu" },
      { text: "Nụ hôn đầu tiên với tư cách vợ chồng 💋", responsible: "Cô dâu & chú rể" },
      { text: "Khách mời vỗ tay, tung confetti/cánh hoa chúc mừng", responsible: "Khách mời" },
    ],
    people: [
  ...
  },
  {
    ...
    steps: [
      ...
      // Ritual steps (non-checkable) — AFTER checklist
      { text: "MC mời cô dâu chú rể đến bàn bánh cưới", responsible: "MC" },
      { text: "Hai người cùng cầm dao, cắt miếng bánh đầu tiên", responsible: "Cô dâu & chú rể" },
      { text: "Cho nhau ăn miếng bánh đầu tiên — ngọt ngào 🥰", responsible: "Cô dâu & chú rể" },
      { text: "Rót champagne (hoặc đổ tháp ly từ trên xuống)", responsible: "Cô dâu & chú rể" },
      { text: "Nâng ly — cả sảnh cùng nâng ly chúc mừng", responsible: "MC" },
      { text: "Uống giao bôi — hai người uống chung 1 ly", responsible: "Cô dâu & chú rể" },
    ],
    people: [
