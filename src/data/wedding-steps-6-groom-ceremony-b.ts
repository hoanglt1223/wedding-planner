...
export const GROOM_CEREMONIES_B: Ceremony[] = [
  {
    ...
    steps: [
      ...
      { text: "MC/người chứng hôn giới thiệu nghi thức Vow — giải thích ý nghĩa" },
      { text: "Nhạc nền acoustic nhẹ nhàng nổi lên — spotlight tập trung" },
      { text: "Chú rể đọc lời thề nguyện trước — nhìn vào mắt cô dâu" },
      { text: "Cô dâu đọc lời thề nguyện — chân thành, xúc động" },
      { text: "Trao nhẫn (nếu chưa trao ở nghi thức trước)" },
      { text: "Nụ hôn đầu tiên với tư cách vợ chồng 💋" },
      { text: "Khách mời vỗ tay, chúc phúc — giây phút thiêng liêng" },
      { text: "Tung confetti / cánh hoa — kết thúc nghi thức" },
    ],
    people: [
  ...
  },
  {
    ...
    steps: [
      ...
      // Ritual steps (non-checkable) — AFTER checklist
      { text: "MC giới thiệu — mời cô dâu chú rể ra sàn nhảy" },
      { text: "Ánh sáng dịu, spotlight tập trung — nhạc nổi lên" },
      { text: "Cô dâu chú rể bước ra — bắt đầu khiêu vũ" },
      { text: "Khiêu vũ 2-3 phút — đơn giản, ngọt ngào" },
      { text: "Father-daughter dance / Mother-son dance (tùy chọn, rất cảm động)" },
      { text: "Mời khách cùng ra sàn nhảy — bắt đầu phần sôi động" },
    ],
    people: [
  ...
  },
  {
    ...
    steps: [
      ...
      // Ritual steps (non-checkable) — AFTER checklist
      { text: "MC mời cô dâu chú rể lên sân khấu — giới thiệu phần cảm ơn" },
      { text: "Nhạc nền nhẹ nhàng — ánh sáng dịu, spotlight tập trung" },
      { text: "Cô dâu đọc thư cho bố mẹ mình — kể kỷ niệm, bày tỏ lòng biết ơn" },
      { text: "Trao quà cho bố mẹ cô dâu — ôm, khóc 😢" },
      { text: "Chú rể đọc thư cho bố mẹ mình — cảm ơn sinh thành dưỡng dục" },
      { text: "Trao quà cho bố mẹ chú rể — ôm, bày tỏ tình cảm" },
      { text: "Bố mẹ hai bên chúc phúc — lời dặn dò cuối cùng" },
      { text: "Cả sảnh xúc động — khoảnh khắc đẹp nhất tiệc cưới" },
    ],
    people: [
