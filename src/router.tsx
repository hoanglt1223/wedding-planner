...
const contractTemplatesRoute = createRoute({
  getParentRoute: () => appRoute,
  path: '/contract-templates',
  component: lazyRouteComponent(() => import('./pages/contract-templates-page'), 'ContractTemplatesPage'),
})

const paymentsRoute = createRoute({
  getParentRoute: () => appRoute,
  path: '/payments',
  component: lazyRouteComponent(() => import('./pages/payment-dashboard-page'), 'PaymentDashboardPage'),
})
...
const emergencyAssistantRoute = createRoute({
  getParentRoute: () => appRoute,
