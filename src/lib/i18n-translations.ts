...
export const TRANSLATIONS: Record<string, Record<Lang, string>> = {
  ...
  "🤖 Xếp Khéo Ngo": { vi: "🤖 Xếp Khéo Ngo", en: "🤖 Smart Assign" },
  "Tự động xếp khách": { vi: "Tự động xếp khách", en: "Auto-assign guests" },
  "Xếp thông minh": { vi: "Xếp thông minh", en: "Smart Assign" },
  "Nhóm theo gia đình/bạn bè": { vi: "Nhóm theo gia đình/bạn bè", en: "Group by family/friends" },
  "Cân nhắc chế độ ăn": { vi: "Cân nhắc chế độ ăn", en: "Consider dietary needs" },
  "Cân bằng sức chứa bàn": { vi: "Cân bằng sức chứa bàn", en: "Balance table capacity" },
  "Xác nhận xếp khéo ngo": { vi: "Xác nhận xếp khéo ngo", en: "Confirm smart assignment" },
  "Việc này sẽ ghi đè sắp xếp chỗ ngồi hiện tại": { vi: "Việc này sẽ ghi đè sắp xếp chỗ ngồi hiện tại", en: "This will overwrite current seating assignments" },
  "Xếp": { vi: "Xếp", en: "Assign" },
  "Bàn": { vi: "Bàn", en: "Tables" },
  "Chỗ ngồi": { vi: "Chỗ ngồi", en: "Seats" },
  "Đã xếp": { vi: "Đã xếp", en: "Assigned" },
  "Tên bàn": { vi: "Tên bàn", en: "Table name" },
  "Tạo bàn đầu tiên": { vi: "Tạo bàn đầu tiên", en: "Create your first table" },
  "👥 Chưa xếp chỗ": { vi: "👥 Chưa xếp chỗ", en: "👥 Unassigned" },
  "🔍 Tìm khách...": { vi: "🔍 Tìm khách...", en: "🔍 Search guests..." },
  "Sửa": { vi: "Sửa", en: "Edit" },
  ...
  "Mới": { vi: "Mới", en: "New" },
  "Đã liên hệ": { vi: "Đã liên hệ", en: "Contacted" },
  "Báo giá": { vi: "Báo giá", en: "Quoted" },
  "Đã đặt": { vi: "Đã đặt", en: "Booked" },
  "Xác nhận": { vi: "Xác nhận", en: "Confirmed" },
  "Đã trả": { vi: "Đã trả", en: "Paid" },
  "Ngân sách": { vi: "Ngân sách", en: "Budget" },
  ...
  "Lưu thông tin nhà cung cấp": { vi: "Lưu thông tin nhà cung cấp", en: "Save vendor info to compare and contact" },
  "Giá thỏa thuận": { vi: "Giá thỏa thuận", en: "Agreed price" },
  "Tiền đặt cọc": { vi: "Tiền đặt cọc", en: "Deposit amount" },
  ...
  "Nhật ký liên lạc": { vi: "Nhật ký liên lạc", en: "Communication Log" },
  "Theo dõi email, cuộc gọi, cuộc họp với nhà cung cấp": { vi: "Theo dõi email, cuộc gọi, cuộc họp với nhà cung cấp", en: "Track emails, calls, meetings with vendors" },
  "Thêm mới": { vi: "Thêm mới", en: "Add New" },
  "Loại liên lạc": { vi: "Loại liên lạc", en: "Communication Type" },
  "Ngày theo dõi (tùy chọn)": { vi: "Ngày theo dõi (tùy chọn)", en: "Follow-up Date (optional)" },
  "Chủ đề": { vi: "Chủ đề", en: "Subject" },
  ...
  "Tất cả trạng thái": { vi: "Tất cả trạng thái", en: "All Status" },
  "Cần theo dõi": { vi: "Cần theo dõi", en: "Needs Follow-up" },
  "Không cần theo dõi": { vi: "Không cần theo dõi", en: "No Follow-up" },
  "Xóa bộ lọc": { vi: "Xóa bộ lọc", en: "Clear Filters" },
  "Chưa có lần liên lạc nào. Thêm lần liên lạc đầu tiên của bạn!": { vi: "Chưa có lần liên lạc nào. Thêm lần liên lạc đầu tiên của bạn!", en: "No communications yet. Add your first one!" },
  "Không tìm thấy lần liên lạc nào phù hợp với bộ lọc.": { vi: "Không tìm thấy lần liên lạc nào phù hợp với bộ lọc.", en: "No communications match your filters." },
  "Theo dõi: ": { vi: "Theo dõi: ", en: "Follow-up: " },
  "Đã xong": { vi: "Đã xong", en: "Done" },
  "Chủ đề...": { vi: "Chủ đề...", en: "Subject..." },
  "Nội dung...": { vi: "Nội dung...", en: "Content..." },
  "Liên Lạc": { vi: "Liên Lạc", en: "Communications" },
  ...
  // Wedding Contracts
  "📄 Hợp Đồng": { vi: "📄 Hợp Đồng", en: "📄 Contracts" },
  "Quản lý hợp đồng và thanh toán": { vi: "Quản lý hợp đồng và thanh toán", en: "Manage contracts and payments" },
  "🔍 Tìm kiếm hợp đồng...": { vi: "🔍 Tìm kiếm hợp đồng...", en: "🔍 Search contracts..." },
  "Thêm hợp đồng mới": { vi: "Thêm hợp đồng mới", en: "Add new contract" },
  "Cập nhật hợp đồng": { vi: "Cập nhật hợp đồng", en: "Update contract" },
  "Quản lý thông tin hợp đồng": { vi: "Quản lý thông tin hợp đồng", en: "Manage contract information" },
  "Xóa hợp đồng này?": { vi: "Xóa hợp đồng này?", en: "Delete this contract?" },
  "Tổng hợp đồng": { vi: "Tổng hợp đồng", en: "Total contracts" },
  "Đang hoạt động": { vi: "Đang hoạt động", en: "Active" },
  "hợp đồng": { vi: "hợp đồng", en: "contracts" },
  "Tổng giá trị": { vi: "Tổng giá trị", en: "Total value" },
  "sắp tới": { vi: "sắp tới", en: "upcoming" },
  "quá hạn": { vi: "quá hạn", en: "overdue" },
  "chờ": { vi: "chờ", en: "pending" },
  "Không tìm thấy hợp đồng": { vi: "Không tìm thấy hợp đồng", en: "No contracts found" },
  ...
  "Ngày bắt đầu": { vi: "Ngày bắt đầu", en: "Start date" },
  "Ngày kết thúc": { vi: "Ngày kết thúc", en: "End date" },
  "Thêm mốc": { vi: "Thêm mốc", en: "Add milestone" },
  "Chưa có mốc thanh toán": { vi: "Chưa có mốc thanh toán", en: "No payment milestones" },
  "Tùy chọn": { vi: "Tùy chọn", en: "Options" },
  "Ngày ký": { vi: "Ngày ký", en: "Signed date" },
  ...
  // Emergency Assistant
  "🚨 Trợ Lý Khẩn Cấp": { vi: "🚨 Trợ Lý Khẩn Cấp", en: "🚨 Emergency Assistant" },
  "Quản lý mọi khẩn cấp trong ngày vui của bạn": { vi: "Quản lý mọi khẩn cấp trong ngày vui của bạn", en: "Manage any emergencies on your big day" },
  "Danh Bạ Khẩn Cấp": { vi: "Danh Bạ Khẩn Cấp", en: "Emergency Contacts" },
  "Gọi Nhanh": { vi: "Gọi Nhanh", en: "Quick Call" },
  "Gửi Email": { vi: "Gửi Email", en: "Send Email" },
  "Xem Địa Chỉ": { vi: "Xem Địa Chỉ", en: "View Address" },
  "Ưu Tiên Cao": { vi: "Ưu Tiên Cao", en: "Critical Priority" },
  "Thêm Liên Hệ": { vi: "Thêm Liên Hệ", en: "Add Contact" },
  "Không có liên hệ khẩn cấp": { vi: "Chưa có liên hệ khẩn cấp", en: "No emergency contacts added" },
  "Cột Mốc Sắp Tới": { vi: "Cột Mốc Sắp Tới", en: "Upcoming Milestones" },
  "Đã Xác Nhận": { vi: "Đã Xác Nhận", en: "Acknowledged" },
  "Xác Nhận": { vi: "Xác Nhận", en: "Acknowledge" },
  "còn lại": { vi: "còn lại", en: "minutes remaining" },
  "Không có cảnh báo nào": { vi: "Không có cảnh báo nào", en: "No alerts" },
  "Chuẩn Bị Sẵn Sàng": { vi: "Chuẩn Bị Sẵn Sàng", en: "Get Ready" },
  "Kế Hoạch Dự Phòng": { vi: "Kế Hoạch Dự Phòng", en: "Backup Plans" },
  "Dựa Trên Thời Tiết": { vi: "Dựa Trên Thời Tiết", en: "Weather-Based" },
  "Điều Kiện Hiện Tại": { vi: "Điều Kiện Hiện Tại", en: "Current Conditions" },
  "Kích Hoạt Dự Phòng": { vi: "Kích Hoạt Dự Phòng", en: "Activate Backup" },
  "Xem Chi Tiết": { vi: "Xem Chi Tiết", en: "View Details" },
  "Chi Phí Ước Tính": { vi: "Chi Phí Ước Tính", en: "Estimated Cost" },
  "Ưu Tiên": { vi: "Ưu Tiên", en: "Priority" },
  "Bắt Buộc": { vi: "Bắt Buộc", en: "Essential" },
  "Khuyến Nghị": { vi: "Khuyến Nghị", en: "Recommended" },
  "Tùy Chọn": { vi: "Tùy Chọn", en: "Optional" },
  "Chưa có kế hoạch dự phòng": { vi: "Chưa có kế hoạch dự phòng", en: "No backup plans set" },
  "Đã Kích Hoạt": { vi: "Đã Kích Hoạt", en: "Activated" },
  "Bộ Đồ Khẩn Cấp": { vi: "Bộ Đồ Khẩn Cấp", en: "Emergency Kit" },
  "Danh Mục": { vi: "Danh Mục", en: "Category" },
  "Số Lượng": { vi: "Số Lượng", en: "Quantity" },
  "Đã Đóng Gói": { vi: "Đã Đóng Gói", en: "Packed" },
  "Chưa Đóng Gói": { vi: "Chưa Đóng Gói", en: "Not Packed" },
  "Đánh Đã Đóng Gói": { vi: "Đánh Đã Đóng Gói", en: "Mark as Packed" },
  "Bỏ Đóng Gói": { vi: "Bỏ Đóng Gói", en: "Unpack" },
  "Y Tế": { vi: "Y Tế", en: "Medical" },
  "Quần Áo": { vi: "Quần Áo", en: "Clothing" },
  "Tài Liệu": { vi: "Tài Liệu", en: "Documents" },
  "Tổng Số Mục": { vi: "Tổng Số Mục", en: "Total Items" },
  "Đủ Đồ Rồi!": { vi: "Đủ Đồ Rồi!", en: "All Set!" },
  "Cần Đóng Gói Thêm": { vi: "Cần Đóng Gói Thêm", en: "Need to Pack" },
  "Ghi Chú": { vi: "Ghi Chú", en: "Notes" },
  "Tổng Quan": { vi: "Tổng Quan", en: "Overview" },
  "Hành Động Nhanh": { vi: "Hành Động Nhanh", en: "Quick Actions" },
  "Gọi Cứu Hộ (112)": { vi: "Gọi Cứu Hộ (112)", en: "Call Emergency (112)" },
  "Kiểm Tra Thời Tiết": { vi: "Kiểm Tra Thời Tiết", en: "Check Weather" },
  "Không Có Vấn Đề Gì": { vi: "Không Có Vấn Đề Gì", en: "No Issues" },
  "Mọi Thứ Đã Sẵn Sàng": { vi: "Mọi Thứ Đã Sẵn Sàng", en: "Everything is Ready" },
};
