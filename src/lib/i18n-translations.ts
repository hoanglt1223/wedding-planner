...
export const TRANSLATIONS: Record<string, Record<Lang, string>> = {
  ...
  "📜 Văn Khấn & Lời Phát Biểu": { vi: "📜 Văn Khấn & Lời Phát Biểu", en: "📜 Prayers & Speeches" },
  "Văn khấn": { vi: "Văn khấn", en: "Prayer" },
  "Phát biểu": { vi: "Phát biểu", en: "Speech" },
  "Dịp sử dụng": { vi: "Dịp sử dụng", en: "Occasion" },
  "Hướng dẫn": { vi: "Hướng dẫn", en: "Guidance" },
  "Tên": { vi: "Tên", en: "Name" },
  "SL": { vi: "SL", en: "Qty" },
  "Giá": { vi: "Giá", en: "Price" },
